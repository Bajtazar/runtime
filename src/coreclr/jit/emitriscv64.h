...
private:
#ifdef DEBUG
void emitIns_SanityCheck(instruction ins);
...
void emitIns_R_I_SanityCheck(instruction ins, regNumber reg);
void emitIns_R_R_SanityCheck(instruction ins, regNumber reg1, regNumber reg2);
void emitIns_R_R_I_SanityCheck(instruction ins, regNumber reg1, regNumber reg2, ssize_t immediate);
...
instrDesc* emitIns_R_S_GenIns(instruction ins, regNumber rd, regNumber rs1, emitAttr attr, ssize_t imm);
void emitIns_R_R_SetFloatInstrAdditionalData(instrDesc* id, instruction ins);
...
void emitIns_S_R_R(instruction ins, emitAttr attr, regNumber reg1, regNumber tmpReg, int varx, int offs);
...
void emitIns_J_R_I(instruction ins, BasicBlock* dst, regNumber reg, ssize_t immediate);
